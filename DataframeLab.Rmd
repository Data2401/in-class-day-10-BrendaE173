...
USPersonalExpenditure <- USPersonalExpenditure %>%
  pivot_longer(
    cols = c(`1940`, `1945`, `1950`, `1955`, `1960`),
    names_to = "Year",
...
USPersonalExpenditure$Category[which.max(USPersonalExpenditure$Expenditure == "1960")]
```
...
lowest_category <- function(year1) {
  df_year <- USPersonalExpenditure[USPersonalExpenditure$Year == year1, ]
  df_year$Category[which.min(df_year$Expenditure)]
}
...
years <- unique(USPersonalExpenditure$Year)
